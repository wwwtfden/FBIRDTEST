...
public class Obstacles {
    class WallPair{
        ...
        int offset;
       // int offset2;
        Rectangle emptySpace; // безопасное расст между трубами

        public WallPair(Vector2 pos){
            position = pos;
            speed = 2;
            offset = new Random().nextInt(250);
          //  offset2 = new Random().nextInt(250);
            emptySpace = new Rectangle(position.x, position.y - offset + 300 ,50, betweenDistance); //проверить
        }
